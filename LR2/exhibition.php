...
<body>
	...
	<div class="row">
        ...
        <h4>Фильтр:</h4><br><br>
		<div class="col-6">
        <form action="exhibition.php" method="post" autocomplete="off">
             <label>По дате:</label>
            <div class="mb-3">
